...
function buildChannelFallbackStatus(
  playbackUrl: string,
  mimeType: string,
  reason: string,
  ...
  return {
    ...
    source: "youtube_channel_fallback",
    videoId: "",
    reason,
    ...details,
  };
...
Deno.serve(async (request) => {
  ...
  try {
    ...
    if (!youtubeResponse.ok) {
      ...
      return json(
        buildChannelFallbackStatus(playbackUrl, mimeType, "youtube_lookup_failed", {
    ...
    return json(
      buildChannelFallbackStatus(playbackUrl, mimeType, "youtube_lookup_exception", {
